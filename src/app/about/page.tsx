            ...
            <div className="container mx-auto flex justify-center items-center px-4 md:px-10">
                <div className="px-3 md:px-4 py-4 flex flex-col justify-center items-center">
                    ...
                    <p className='mt-4 text-white/90 text-base leading-normal text-center md:w-9/12 lg:w-7/12 '>
                        {`Welcome to your one-stop source for informative news and engaging articles! Our mission is to provide you with high-quality content that keeps you informed, educated, and entertained.
                        We cover a wide range of topics, from current events and breaking news to in-depth analysis and thought-provoking features. Our team of dedicated writers and editors is committed to bringing you the latest information in a clear, concise, and engaging way.`}
                    </p>
